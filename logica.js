biblioteca = [
  ...
  {"estrutura": "Lisossomos", "imagem": "lisossomo.jpg", "descricao": "Organela responsável pela digestão, seja de líquidos, ou de sólidos, pelos processos de pinocitose e fagocitose, respectivamente. Os lisossomos também podem digerir estruturas da própria célula, processo denominado autólise"},
  ...
  {"estrutura": "Núcleo","imagem": "nucleo.jpg", "descricao": "Talvez a região mais importante de toda a célula, já que essa contém o DNA, estrutura responsável por indicar como as proteínas serão produzidas, e que consequentemente irá dar as caracteristica de cada ser, seja ele animal, vegetal, bacterias, etc."},
  ...
  {"estrutura": "Peroxissomos","imagem": "peroxissomo.jpg", "descricao": "São estruturas ricas em enzimas que quebram a água oxigenada, tóxica aos seres vivos, transformando essa em moléculas de água e de oxigênio"},
  ...
  {"estrutura": "Mitocôndria","imagem": "mitocondria.png", "descricao": "Ela tem de 0,2 µm a 1 µm de diâmetro e 2 µm a 10 µm de comprimento. A forma pode ser: esférica, ovóide, filamentosa. Está relacionada ao fornecimento de energia. A quantidade de mitocôndrias varia para células de diferentes origens, estando diretamente relacionada à demanda energética da célula."},
  {"estrutura": "Retículo endoplasmático","imagem": "reticulo.jpg", "descricao": "Dividido em dois tipo o rugoso e o liso, o primeiro chamado de rugoso, onde contém vários ribossomos responsáveis pela síntese  proteica, o segundo chamado de liso, que apesar de não ter ribossomos contém enzimas que sintetisam lipídeos"},
